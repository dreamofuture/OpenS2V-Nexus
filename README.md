...
* ⏳⏳⏳ Evaluating more Subject-to-Video Generation Models and updating the [![hf_space](https://img.shields.io/badge/🤗-Leaderboard-blue.svg)](https://huggingface.co/spaces/BestWishYsh/OpenS2V-Eval). PRs are welcome!
* `[2025.05.27]`  🔥 Our **arXiv** paper on OpenS2V-Nexus is now available; click [here](https://arxiv.org/) for details.
