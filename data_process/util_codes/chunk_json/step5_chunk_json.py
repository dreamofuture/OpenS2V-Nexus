...
def main():
    ...
    parser.add_argument(
        "--input_video_json",
        type=str,
        default="../0_demo_output/step5/merge_input_json/dataset1.json",
    )
    parser.add_argument(
        "--output_chunk_json_folder",
        type=str,
        default="../0_demo_output/step6/chunk_input_json/dataset1",
    )
    parser.add_argument(
        "--resume_dir", type=str, default="../0_demo_output/step6/final_output/dataset1"
    )
