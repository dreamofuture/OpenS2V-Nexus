...
def main():
    ...
    parser.add_argument(
        "--input_video_json",
        type=str,
        default="../../demo_result/step4/cross-frames-images/cluster_videos.json",
    )
    parser.add_argument(
        "--output_chunk_json_folder",
        type=str,
        default="../../demo_result/step5/cross-frames-images/chunk_input_json",
    )
    parser.add_argument(
        "--resume_dir",
        type=str,
        default="../../demo_result/step5/cross-frames-images/final_output",
    )
