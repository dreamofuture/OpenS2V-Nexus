...
def generate_bash_scripts(
    ...
    for machine_num in range(num_machines):
        ...
        for dataset_name in dataset_names:
            ...
            bash_script += f"    CUDA_VISIBLE_DEVICES=$((i % {num_gpus})) python step6_EfficientTAM/step6-2_TAM_single_groundingdino.py --input_video_root ${{INPUT_VIDEO_ROOT}} --input_video_json ${{INPUT_VIDEO_JSON}} --output_json_folder ${{OUTPUT_JSON_FOLDER}} & \\\n"
...
input_video_json_dir = "demo_result/step5/chunk_input_json"
output_json_folder = "demo_result/step5/final_output"
